...
function CampaignDetails() {
  ...
  return (
    <>
      <div className="py-16 px-8 md:px-16 lg:px-32 flex flex-col md:flex-row gap-6 mb-8">
        {/* Campaign Image */}
        {campaign.length > 0 ? (
          <p>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {contributions.flat().map((contributor, index) => (
                    <tr key={index}>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {contributor.contributor.toString()}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {Number(contributor.amount).toLocaleString()} ICP
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {new Date(
                          Number(contributor.timestamp) / 1e6
                        ).toLocaleDateString("en-US", {
                          year: "numeric",
                          month: "short",
                          day: "numeric",
